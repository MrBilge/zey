    ...
    <article className={styles.page}>
        ...
        <div className={styles.rootsCopy}>
          <p className={styles.rootsStory}>
            ...
            <span className={styles.rootsBody}>
              aileden gelen bir emeğin ve yıllardır devam eden bir sofranın parçası.
              Ağaçlarımızdan toplanan zeytinlerden elde edilen yağ, uzun zamandır önce
              kendi soframızda, ardından yakınlarımızın ve dostlarımızın sofralarında
              yerini buluyor.
            </span>
          </p>
        </div>
      ...
      <section className={`wrap ${styles.harvest}`}>
        ...
        <div className={styles.harvestCopy}>
          ...
          <p className={styles.bodyCopy}>
            Zamanla fark ettik ki yıllardır ailemiz ve çevremiz için ürettiğimiz bu
            zeytinyağını daha fazla sofrayla buluşturmak istiyoruz. Böylece
            Gümülceli’nin zeytinlerinden başlayan bu küçük aile hikâyesini, kendi adı
            ve kimliği olan bir markaya dönüştürmeye karar verdik.
          </p>
      ...
      <section className={styles.promise}>
        <div className={`wrap ${styles.promiseInner}`}>
          ...
          <p>
            Kendi soframıza gönül rahatlığıyla koyduğumuz ürünü, aynı özenle sizin
      ...
      <section className={`wrap ${styles.tableStory}`}>
        ...
        <div className={styles.tableCard}>
          ...
          <p>
            Nereden geldiğini bildiğimiz, hikâyesini bildiğimiz ve kendi soframıza
            gönül rahatlığıyla koyduğumuz bir ürünü aynı özenle sizin sofranıza
            ulaştırmak.
          </p>
      ...
      <div className={`wrap ${styles.manifesto}`} aria-label="Zey değerleri">
        <span>TOPRAK</span>
        <i>→</i>
        <span>EMEK</span>
        <i>→</i>
